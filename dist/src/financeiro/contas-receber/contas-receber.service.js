...
let ContasReceberService = ContasReceberService_1 = class ContasReceberService extends base_tenant_service_1.BaseTenantService {
    tenantPrisma;
    logger = new common_1.Logger(ContasReceberService_1.name);
...
exports.ContasReceberService = ContasReceberService = ContasReceberService_1 = __decorate([
