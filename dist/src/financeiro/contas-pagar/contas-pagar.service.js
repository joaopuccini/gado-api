...
let ContasPagarService = ContasPagarService_1 = class ContasPagarService extends base_tenant_service_1.BaseTenantService {
    tenantPrisma;
    logger = new common_1.Logger(ContasPagarService_1.name);
...
exports.ContasPagarService = ContasPagarService = ContasPagarService_1 = __decorate([
