...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Cadastrar lote' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [lote_dto_1.CreateLoteDto]),
    __metadata("design:returntype", Promise)
], LotesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)('buscar'),
    (0, swagger_1.ApiOperation)({ summary: 'Listar todos os lotes' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Buscar lote por ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Editar lote' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, lote_dto_1.UpdateLoteDto]),
    __metadata("design:returntype", Promise)
], LotesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)('deletar/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Excluir lote (soft-delete)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
