...
let SafrasService = SafrasService_1 = class SafrasService extends base_tenant_service_1.BaseTenantService {
    tenantPrisma;
    logger = new common_1.Logger(SafrasService_1.name);
    modelName = 'safra';
...
exports.SafrasService = SafrasService = SafrasService_1 = __decorate([
