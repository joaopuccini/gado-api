...
let ManutencoesService = ManutencoesService_1 = class ManutencoesService extends base_tenant_service_1.BaseTenantService {
    tenantPrisma;
    logger = new common_1.Logger(ManutencoesService_1.name);
    ...
    getDelegate(tenant) {
        return tenant.manutencao;
    }
};
exports.ManutencoesService = ManutencoesService;
exports.ManutencoesService = ManutencoesService = ManutencoesService_1 = __decorate([
