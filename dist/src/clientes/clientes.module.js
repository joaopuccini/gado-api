...
exports.ClientesModule = ClientesModule = __decorate([
    (0, common_1.Module)({ controllers: [clientes_controller_1.ClientesController], providers: [clientes_service_1.ClientesService], exports: [clientes_service_1.ClientesService] })
], ClientesModule);
