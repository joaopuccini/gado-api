...
const statusByCode: Readonly<Record<ErrorCode, number>> = {
  ...
  emptyCustomProfile: HttpStatus.UNPROCESSABLE_ENTITY,
  invalidPermissionSelection: HttpStatus.UNPROCESSABLE_ENTITY,
  profileNameAlreadyExists: HttpStatus.CONFLICT,
  profileNotFound: HttpStatus.NOT_FOUND,
